CONFIG = {
    ...
    # Should be used for PID (Prague) and IDS JMK data.
    ...
    "TRANSFER_NODE_ID": "asw_node_id", # Use for Prague (PID) data
    # "TRANSFER_NODE_ID": "stop_code", # Use for Olomouc (DPMO) data
    # "TRANSFER_NODE_ID": None, # Use for transfer modes other than "by_node_id"

    # The minimum time, in minutes, needed for a transfer between two stops in the same station/area.
